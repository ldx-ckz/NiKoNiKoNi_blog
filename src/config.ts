...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/desktop-banner-01-v20260818.jpg",
				"/assets/desktop-banner/desktop-banner-02-v20260818.png",
				...
				"/assets/desktop-banner/desktop-banner-11-v20260818.png",
			], // 桌面横幅图片
			mobile: [
				"/assets/mobile-banner/mobile-banner-01-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-02-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-03-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-04-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-05-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-06-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-07-v20260818.png",
				"/assets/mobile-banner/mobile-banner-08-v20260818.png",
				"/assets/mobile-banner/mobile-banner-09-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-10-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-11-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-12-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-13-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-14-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-15-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-16-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-17-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-18-v20260818.jpg",
				"/assets/mobile-banner/mobile-banner-19-v20260818.jpg",
			], // 移动横幅图片
		}, // 使用本地横幅图片
	...
	toc: {
		enable: true, // 启用目录功能
		depth: 3, // 目录深度，1-6，3 表示显示 h1、h2 和 h3 标题
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to nikonikoni's blog!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
		...
		link: "https://github.com/ldx-ckz/NiKoNiKoNi_blog", // 关于链接
	},
};
...
export const umamiConfig = {
	...
	apiKey: import.meta.env.UMAMI_API_KEY || "", // API密钥优先从环境变量读取
	baseUrl: "https://api.umami.is", // Umami Cloud API地址
	scripts: "",
} as const;

export const pageviewCounterConfig = {
	enabled: true,
	endpoint: "https://counter.nikonikoni.blog",
} as const;
