...
image: /assets/post-card/post-card-13-v20260818.jpg
...
索引 `index.md` 负责按内容导航，`log.md` 负责按时间记录操作。本 vault 使用 [知识库首页](/resources/codex-obsidian-knowledge-base/知识库首页.md) 和 [变更日志](/resources/codex-obsidian-knowledge-base/变更日志.md) 实现相同职责。
...
如果以后某个研究项目需要特殊规则，可以在项目文件夹中增加更具体的 `AGENTS.md`。
