...
**命题 1** 集合 $\{x \in \mathbb{Q} : x^2 < 2\}$ 在 $\mathbb{Q}$ 中无上确界。
...
### 定理与推论
**定理 3（阿基米德原理）** 自然数集合 $\mathbb{N}$ 是无上界的。
...
**推论 1** $\forall \varepsilon > 0 \exists N \in \mathbb{N} \forall n \in \mathbb{N}(n \geq N \implies 1/n < \varepsilon)$
